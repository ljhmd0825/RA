...
export CFLAGS="$CFLAGS -O3 -flto -ffunction-sections -fdata-sections -flto=auto -DHAVE_SCREEN_ORIENTATION -DGEOMETRY_MENU_ROTATION -D_GNU_SOURCE -DHAVE_FILTERS_BUILTIN -fno-PIE"
export CXXFLAGS="$CXXFLAGS -O3 -ffunction-sections -fdata-sections -flto=auto -DHAVE_SCREEN_ORIENTATION -DGEOMETRY_MENU_ROTATION -D_GNU_SOURCE -DHAVE_FILTERS_BUILTIN -fno-PIE"
export LDFLAGS="$LDFLAGS -Wl,--gc-sections -flto=auto -no-pie"
